  ...
  <section class="py-20 bg-white-50">
    <div class="def-container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center max-w-4xl mx-auto">
        ...
        <!-- Main Heading -->
        <h2 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#E2725B] leading-tight mb-8">
          A local marketing agency for UK businesses with proven results.
        </h2>

        <!-- Italic Subheading -->
        <p class="text-2xl sm:text-3xl text-gray-800 font-medium italic mb-8">
          We're dedicated to helping local businesses succeed.
        </p>

        <!-- Description -->
        <p class="text-lg sm:text-xl text-gray-600 leading-relaxed mb-12 max-w-3xl mx-auto">
        ...
        <div class="flex justify-center">
          <button @click="$emit('openModal')"
            ...
            Let's Grow Together
            <div
              class="flex items-center justify-center w-8 h-8 bg-white/20 rounded-full transition-transform duration-300 ease-in-out hover:translate-x-1">
